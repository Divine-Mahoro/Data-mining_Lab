...
\title{\textbf{Data Mining Assignment I}}
\author{Divine Mahoro\\ID: 101199\\Group 2}
\date{}
...
Substituting into the definition of $R^2$:
\[
R^2=\frac{TSS-RSS}{TSS}
=\frac{\hat{\beta}_1\sum_i x_i y_i}{\sum_i y_i^2}.
\]

Substituting the slope estimate:
\[
R^2=
\frac{\left(\sum_i x_i y_i\right)^2}
{\left(\sum_i x_i^2\right)\left(\sum_i y_i^2\right)}
...
For these two coefficient estimates to be exactly equal, their denominators must be equal. Therefore,
\[
